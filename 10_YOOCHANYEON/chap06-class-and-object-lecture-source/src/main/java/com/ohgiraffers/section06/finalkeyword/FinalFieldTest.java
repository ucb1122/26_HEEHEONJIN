...
public class FinalFieldTest {
    ...
    * 초기 인스턴스 생성 시 기본 값 0이 필드에 들어가게 되는데 값 변경이
    * 불가능하므로 선언과 동시에 초기화 필요*/
...
//    private final int STATIC_NUM;
    ...
    /* static field 는 생성자 초기화가 불가능
    * static 초기화 블럭을 활용 가능*/
    static{
        STATIC_NAME = "홍길동";
    }

    /* final과 static 키워드의 나열 순서는 문법적으로 상관 x
    * 다만 주로 static final로 작성됨*/
