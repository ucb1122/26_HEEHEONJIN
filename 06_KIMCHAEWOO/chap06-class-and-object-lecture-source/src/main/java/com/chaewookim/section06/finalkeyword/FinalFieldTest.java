package com.chaewookim.section06.finalkeyword;
...
public class FinalFieldTest {
    ...
    * 초기 인스턴스 생성 시 기본값 0이 필드에 들어가게 되는데 값 변경이 불가능하므로
    * 선언과 동시에 초기화해야함
    * */
