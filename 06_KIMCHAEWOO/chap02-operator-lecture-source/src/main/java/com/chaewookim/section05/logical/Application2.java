package com.chaewookim.section05.logical;
...
public class Application2 {
    public static void main(String[] args) {
        ...
        int num12 = 10;
        int num222 = -10;
        String result11 = (num12 > 0)? "양수다.": "양수가 아니다.";
        String result22 = (num222 > 0)? "양수다.": "양수가 아니다.";

        System.out.println("num1은 " + result11);
