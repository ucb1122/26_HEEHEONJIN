...
public class Application2 {
    ...
    public static void main(String[] args) {
         ...
         */
        // 1차원 배열에 출석부 넣기
        String [] arrD1 = {"홍길동", "이순신", "유관순", "윤봉길", " 장영실", "임꺽정",
                "장보고", "이태백", "김정희", "대조영", "김유신", "이사부"};

        // 2차원 배열 만들고 초기화 하기(2개)
        String [][] arrD21 = new String[3][2];
        String [][] arrD22 = new String[3][2];
        ...
        for(int i = 0; i < 3; i++) {
            for(int j = 0; j < 2; j++) {
                arrD21[i][j] = arrD1[cnt];
                System.out.print(arrD1[cnt] + " ");
                cnt ++;
            }
            System.out.println();
        }
