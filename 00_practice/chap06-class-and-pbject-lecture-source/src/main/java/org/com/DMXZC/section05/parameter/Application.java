...
public class Application {
    public static void main(String[] args) {
        ...
        * */
        ...
        int[] iArr = new int[] {1,2,3,4,5}; // iArr 안에는 heap에 생성된 배열의 주소값을 가지고 있다.
        ...
        //클래스 자료형을 매개변수로 전달 받는 메소드 호출
        Rectangle r = new Rectangle(22, 12);
//        r.calArea();
//        r.calRound();
        pt.testClassTypeParameter(r);

        // 가변인자를 매개변수로 전달받는 메소드 호출(자바는 왠만하면 권장)
        pt.testVariableLengthArrayParameter();
        pt.testVariableLengthArrayParameter("홍골동");
