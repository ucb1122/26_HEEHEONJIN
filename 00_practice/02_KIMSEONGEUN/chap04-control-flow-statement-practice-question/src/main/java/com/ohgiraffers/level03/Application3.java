...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        if(avg >= 60 && korean >= 40 && english >= 40 && math >= 40) {
            ...
            if(korean < 40) System.out.println("국어 과목의 점수 미달로 불합격 입니다.");
            if(english < 40) System.out.println("영어 과목의 점수 미달로 불합격 입니다.");
            if(math < 40) System.out.println("수학 과목의 점수 미달로 불합격 입니다.");
        }
    }
}