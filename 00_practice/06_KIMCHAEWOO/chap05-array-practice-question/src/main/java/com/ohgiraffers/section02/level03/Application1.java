...
//        app.arrayTest7(arr);
    ...
    public void arrayTest4(int[][] arr) {
        ...
        for (int i = 0; i < arr.length; i++) {
            for (int j = 0; j < arr[i].length; j++) {
                arr[i][j] = arr.length * arr[i].length - j*arr.length - i;
                System.out.print(arr[i][j] + " ");
            }
            System.out.println();
        }
    ...
    public void arrayTest5(int[][] arr) {
        for (int i = 0; i < arr.length; i++) {
            for (int j = 0; j < arr[i].length; j++) {
                arr[i][j] = arr.length*arr[i].length - (i+1)*arr.length + j + 1;
                System.out.print(arr[i][j] + " ");
            }
            System.out.println();
        }
