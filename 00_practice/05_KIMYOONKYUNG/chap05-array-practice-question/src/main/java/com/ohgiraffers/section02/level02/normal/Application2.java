...
public class Application2 {
    ...
    public static void main(String[] args) {
         ...
         */
                ...
                String[][] b1 = new String[3][2]; // 1분단
                String[][] b2 = new String[3][2]; // 2분단
                ...
                for (int i = 0; i < b1.length; i++) {
                    for (int j = 0; j < b1[i].length; j++) {
                        ...
                        b1[i][j] = students[studentIndex];


                        System.out.print(b1[i][j] + (j < b1[i].length - 1 ? " " : ""));
                ...
                for (int i = 0; i < b2.length; i++) {
                    for (int j = 0; j < b2[i].length; j++) {
                        ...
                        b2[i][j] = students[studentIndex];


                        System.out.print(b2[i][j] + (j < b2[i].length - 1 ? " " : ""));
