...
//        String[] first = new String[12];
        ...
        String[][] second1 = new String[3][2]; // 1분단
        String[][] second2 = new String[3][2]; // 2분단
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 2; j++) {
                if (counter == 6) break;
                second1[i][j] = first[counter];
                counter++;
                System.out.print(second1[i][j] + " ");
            }
            System.out.println();
        }
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 2; j++) {
                if (counter == 13) break;
                second2[i][j] = first[counter];
                counter++;
                System.out.print(second2[i][j] + " ");
            }
            System.out.println();
        }
