package com.hihi.section05.parameter;
...
public class Application {
    public static void main(String[] args) {
        ...
        * 리터럴값  (참조 주소값 X)을 전달해서 메소드를 호출 시에는 서로 다른 지역변수는 서로 영향 X*/
        ...
        pt.teestPrimitiveTypeParameter(num);
        ...
        * */
        ...
        //5. 가변인자를 매개변수로 전달받는 메소드 호출
        pt.testVariableLengthArrayParameter();      //가변인자를 받기 때문에 아무것도 안넣어도 정상작동
