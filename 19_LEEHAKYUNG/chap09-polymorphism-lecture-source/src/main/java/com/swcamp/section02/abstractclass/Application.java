...
//        Product product = new Product();  >> 이렇게 하면 에러남.
        ...
        // 정적 바인딩 -> Product, 동적 바인딩 -> SmartPhone으로 감.
        product.abstMethod();
