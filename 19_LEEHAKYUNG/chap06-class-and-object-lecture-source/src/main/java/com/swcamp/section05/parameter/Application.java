...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /*
        2. 기본자료형 배열을 매개변수로 전달 받는 메소드 호출 >>> 주소값 공유
         */
        int[] iArr = new int[] {1, 2, 3, 4, 5}; // iArr안에는 heap에 생성된 배열의 주소갑을 가지고 있다.
        ...
        /*
        3. 클래스 자료형을 매개변수로 전달 받는 메소드 호출 >>> 주소값 공유
         */
        ...
        pt.testVariableLengthArrayParameter("유관순", "탁구", "독서");
        pt.testVariableLengthArrayParameter(new String[]{"안녕", "하세요", "ㅎㅎ"});
    }
}
