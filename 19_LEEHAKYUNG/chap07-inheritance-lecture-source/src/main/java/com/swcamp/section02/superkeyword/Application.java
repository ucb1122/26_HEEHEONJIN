...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        Product product2 = new Product("s-01234", "삼성", "갤럭시z폴드", 3000000, new Date());
        System.out.println(product2.getInformation());

        Computer computer1 = new Computer();
        System.out.println(computer1.getInformation());

        Computer computer2 = new Computer("퀄컵 스냅드래곤", 512, 24, "안드로이드");
        System.out.println(computer2.getInformation());

        Computer computer3 = new Computer("s-01234", "삼성", "갤럭시z폴드", 3000000, new Date(), "퀄컵 스냅드래곤", 512, 24, "안드로이드");
