...
//
//        Product product2 = new Product("s-01234", "삼숭", "갤S25", 3000000, new Date());
//        System.out.println(product2.getInformation());
        /*기본값만: null*/
        Computer computer1 = new Computer();
        System.out.println(computer1.getInformation());
        /*내 것만*/
        Computer computer2 = new Computer("퀄컴 스냅드래곤", 512, 24, "Android");
        System.out.println(computer2.getInformation());
        /*부모 것도 다!!*/
        Computer computer3 = new Computer("s-01234", "삼숭", "갤S25", 3000000, new Date(),"퀄컴 스냅드래곤", 512, 24, "Android");
