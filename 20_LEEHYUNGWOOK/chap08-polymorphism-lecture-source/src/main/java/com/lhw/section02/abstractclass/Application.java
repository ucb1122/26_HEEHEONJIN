...
public class Application {
    ...
    public static void main(String[] args) {
        /*
        * 추상메소드 0개 이상 포함하는 클래스를 추상클래스라 한다.
        * 추상 클래스는 클래스 선언부에 abstract 키워드를 명시해야 한다.
        * 추상클래스로는 인스턴스 생성 불가
        * 추상클래스를 사용하려면 추상 클래스를 상속받는 하위 클래스를 이용해서 인스턴스를 생성해야한다.
        ...
        * 추상 메소드란?? ⇒ 메소드의 선언부만 있고 구현부가 없는 메소드를 추상메소드라고 한다. 추상메소드의 경우 반드시 abstract키워드를 메소드 헤드에 작성해야 한다.
