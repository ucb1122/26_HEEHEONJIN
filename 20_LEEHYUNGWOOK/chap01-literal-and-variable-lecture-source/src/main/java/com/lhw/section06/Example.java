...
public class Example {
    ...
    public static void main(String[] args) {
        ...
        int price = 12000;
        int quantity = 3;
        double Pre_tax = price * quantity;
        double Tax = Pre_tax * TAX_RATE;
        double After_tax = Pre_tax + (Tax);

        System.out.println("세전 금액: " + Pre_tax + "원");
        System.out.println("부가세: " + Tax + "원");
        System.out.println("세후 금액: " + After_tax + "원");
        System.out.println("최종 결제 금액: " + (int) After_tax + "원");
