...
public class Application2 {
    ...
    public static void main(String[] args) {
        /* 배열의 선언 : stack에 배열의 주소를 보관할 ** 레퍼런스 변수 ** 공간을 만드는것*/
        int[] iarr;     //int i;
        ...
        * 발생한 주소가 래퍼런스 변수(참조형변수)에 저장되고 이것을 참조하여 사용하기 때문에
        * 참조 자료형이라고 한다.
         */
        ...
        * String 클래스는 메소드로 제공하여 length()로 사용하는 점에 유의한다.
        ...
        /* 한 번 저장한 배열의 길이는 변경할 수 없다.
        * 새로운 배열을 생성하여 그 주소값을 래퍼런스 변수에 담는다.
         */
        iarr = new int[100];
        ...
        /*
         * 래퍼런스 변수가 아무런 주소를 참조하지 않는 상태를 null이라고 한다.
         * 100개짜리의 배열이 더 이상 참조되지 않으므로 GC(가비지 컬렉터)에 의해 제거된다.
         */
        iarr = null;

        /*
        * null이라는 특수한 값을 참조하고 있을 경우 참조 연산자(.)를 사용시
        * java.lang.NullPointerExcemption이 발생한다.
         */
