...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        Product product2 = new Product("ss","샘송","갤럭시",300000,new Date());
        System.out.println(product2.getInformation());

        Computer computer1 = new Computer();
        System.out.println(computer1.getInformation());

        Computer computer2 = new Computer("dd",11,33,"dd");
        System.out.println(computer2.getInformation());

        Computer computer3 = new Computer("ss","샘송","갤럭시",300000,new Date(),"dd",11,33,"dd");
