...
public class Application1 {
    public static void main(String[] args) {
        ...
        System.out.println("보너스를 포함한 급여: "+(100000+2000000)+ "원");

        int salary = 100000000;
        int bonus = 2000000;
        System.out.println("보너스를 포함한 급여: "+(salary+bonus));

        //2. 한번 저장해둔 값은 재사용하기 위한 목적
        ...
        sum = sum+10; // 현재 sum의 값은 0이고, 0과 1을 더한 결과를 sum변수에 저장
        ...
        System.out.println("sum에 10을 4번 누적하면 sum의 값은?"+50);
    }
