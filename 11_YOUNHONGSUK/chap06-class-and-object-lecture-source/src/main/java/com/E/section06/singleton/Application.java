...
public class Application {
    public static void main(String[] args) {
        ...
        EagerSingleton ea = EagerSingleton.getInstance();
        EagerSingleton eab = EagerSingleton.getInstance();

        System.out.println("ea " + ea.hashCode());
        System.out.println("eab " + eab.hashCode());


        LazySingleton lazy = LazySingleton.getInstance();
        LazySingleton lazyab = LazySingleton.getInstance();
        System.out.println("lazy " + lazy.hashCode());
        System.out.println("lazyab " + lazyab.hashCode());
