...
public class Application1 {
    public static void main(String[] args) {
        ...
        System.out.println("animal1dl Object 타입인지 확인 : "+(animal1 instanceof Object));
        ...
        /**
         * 클래스 형변환은 up-casting, down-casting으로 구분할 수 있다.
        ...
        Animal aniaml4=new Rabbit();//위랑 똑같은 거임
