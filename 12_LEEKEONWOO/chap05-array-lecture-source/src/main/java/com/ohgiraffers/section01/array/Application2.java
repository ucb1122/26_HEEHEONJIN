...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        iarr = new int[5]; // int 값을 5개 관리하기위한 공간을 만들었다.
        darr = new double[10];

        /*
         * heap영역은 이름으로 접근하지 않고 주소값으로 접근하는 영역이다.
         * stack에 저장된 두소로 heap에 할당 된 배열을 찾아갈 수 있다.
         * */
        System.out.println("iarr : " + iarr); // -> [I@7ad041f3 [I int
        System.out.println("darr : " + darr); // -> [D@7344699f [D double
