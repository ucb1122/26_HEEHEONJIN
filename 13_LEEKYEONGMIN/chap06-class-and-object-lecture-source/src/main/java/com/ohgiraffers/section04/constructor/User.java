...
//    접근제한자 클래스명([매개변수]){}
//
//    기본생성자 : 클래스내부에 작성된 생성자가 0개인 경우 컴파일러가 자동으로 기본생성자를 생성한다.     */
////    public User(){
////        System.out.println("User 기본 생성자 동작함");
////}
//            /*
//            매개변수 생성자" :
//            초기화될 필드가 여러개 일경우 초기화하고 싶은 필드의 조합별로
//            생성자를 여러개 작성할 수 있다.
//             */
...
//    }
//
//    public User(String id, String pwd, String name, String enrollDate) {
//
//        //this.id = id;
//        //this.pwd = pwd;
//        /*
...
//    }
//
////    public User(String user03, String pass03, String 홍길동, String date) {
////    }
//
