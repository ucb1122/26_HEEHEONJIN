...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        //num1 = num1 + 1;
        num1 += 1;
        System.out.println("num1 = " + num1); // 오버플로우 발생 > -128

        num1 += 1;
        System.out.println("num1 = " + num1); // 오버플로우 발생 > -127
        ...
        System.out.println("longMulti = " + longMulti); // int로 계산 한 값 대입

        // 강제형변환
        long result = (long)firstNum * (long)secondNum; // 작은 자료형은 큰 자료형을 따라감
