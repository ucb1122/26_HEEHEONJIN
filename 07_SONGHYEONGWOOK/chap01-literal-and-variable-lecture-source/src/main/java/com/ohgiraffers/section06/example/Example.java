...
public class Example {
     ...
     */
            ...
            double taxPrice = preTax * TAX_RATE;
            double afterTaxPrice = preTax + taxPrice;
            int totalPrice = (int) afterTaxPrice;

            System.out.println("세전 금액: " + preTax + "원");
            System.out.println("부가세: " + taxPrice + "원");
            System.out.println("세후 금액: " + afterTaxPrice + "원");
