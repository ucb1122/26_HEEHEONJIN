...
public class FireCar extends Car {
    ...
    * */
    ...
    public FireCar() {
        ...
        * */
//        super(); // 주석에 상관없이 super()는 무조건 실행됨. 부모클래스를 찾아감
        System.out.println("FireCar클래스 기본 생성자 호출");
    }

    /*
    * soundHorn 메소드 재작성 : override
    ...
    * */
    ...
    public void soundHorn() {
        /*
        * private 접근제어자가 붙은 필드는 상속은 받지만 자식이 접근할 수는 없다.
    ...
    /* 상속은 자식 클래스가 부모 클래스를 확장하는 것이므로 FireCar만의 추가 기능도 작성가능하다. */
