...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        *
        * Rabiit은 Rabbit타입이기도 하면서 Animal타입이기도 하다.
...
//        Tiger tiger1 = new Animal();
        ...
        /* 컴파일 시에는 Animal로 등록 됐다가, 실행 시 자식 클래스의 Override 된 내용이 있다면
        * 그 Override된 메소드가 우선 실행되는 것이 동적 바인딩
        * */
        animal1.cry();
        animal2.cry();
...
//        ((Tiger) animal1).bite();
        ...
        * */
        ...
        System.out.println("animal1이 Tiger 타입인지 확인 : " + (animal1 instanceof Rabbit)); // true
        ...
        /*
        * 클래스 형변환은 up-castiong과 down-casting으로 구분할 수 있다.
        ...
        * */
        ...
        Animal anmial4 = new Rabbit();          // 업캐스팅(묵시적 형변환)

        Rabbit rabbit1 = (Rabbit) animal3;      // Animal -> Rabbit 다운캐스팅
                                                // 명시적 형변환
//        Rabbit rabbit2 = animal3;             // 다운캐스팅 묵시적 형변환은 안된다.
