...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        /* 배열의 선언 : stack에 배열의 주소를 보관할 *래퍼런스 변수*공간을 만드는 것 */
        int[] iarr; // int i;
        ...
        * */
        ...
        /*
        * hashCode() : 객체의 주소값을 10진수로 변환하여 생성한
        * 객체의 고유 정수값을 반환하는 메소드
        * */
        System.out.println("irr.hashCode() : " + iarr.hashCode());
        System.out.println("drr.hashCode() : " + darr.hashCode());
