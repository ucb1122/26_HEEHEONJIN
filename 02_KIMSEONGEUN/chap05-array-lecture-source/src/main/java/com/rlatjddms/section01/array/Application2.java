package com.rlatjddms.section01.array;
...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * new 연산자는 heap 영역에 공간을 할당하고 발생한 조수값을 반환한다.
        * 발생한 주소가 레퍼런스 변수(참조형변수)에 저장되고 이것을 참조하여 사용하기 때문에
        * 참조 자료형이라고 한다.
         */
        iarr = new int[5];  // int값을 5개 관리하기 위한 공간을 만들었디.
        darr = new double[10];
        ...
        * 100개 따리의 배열이 더 이상 참조 되지 않으므로 GC(가비지 컬렉터)에 의해 제거된다.0
         */
        iarr = null;
