...
public class example {
     ...
     */
        ...
        int price = 12000;
        int quantity = 3;
        int sum_pretax = price * quantity;
        System.out.println("세전 금액 : " + sum_pretax + "원");
        double tax = sum_pretax * TAX_RATE;
        System.out.println("부가세 : " + tax + "원");
        double sum_afterTax = sum_pretax + tax;
        System.out.println("세후 금액 : " + sum_afterTax + "원");
        int show_price = (int)(sum_afterTax);
        System.out.println("최종 결제 금액 : " + show_price + "원");
