...
public class application2 {
    public static void main(String[] args) {
         ...
         * */
        int result2 = (true || ++num12 > 0)? num12 : num12;

        System.out.println("||실행 확인 : " + result2);		//10

        int num21 = 10;
        int num22 = -10;
        String result21 = (num21 > 0)? "양수다.": "양수가 아니다.";
        String result22 = (num22 > 0)? "양수다.": "양수가 아니다.";

        System.out.println("num1은 " + result21);
        System.out.println("num2는 " + result22);
        ...
        String result3 = (num23 > 0)? "양수다.": (num23 == 0)? "0이다.":"음수다.";
        String result4 = (num24 > 0)? "양수다.": (num24 == 0)? "0이다.":"음수다.";
        String result5 = (num25 > 0)? "양수다.": (num25 == 0)? "0이다.":"음수다.";
