...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("byte 값의 범위 : " + Byte.MIN_VALUE + "~" + Byte.MAX_VALUE); //byte의 기본값은 0이다.
        ...
        num1++; // 후위증감연산자 : 기본의 num 변수에 있던 값에 1을 더해 다시 대입
        // num = num + 1;
...
//        num1 =  num1 + 1;
        ...
        int multi = firstNum * secondNum; // 7천억 700000000000
        System.out.println("nmulti = " + multi);

        // 강제형변환
        long result = (long) firstNum * secondNum; // 작은 자료형은 큰 자료형을 따라간다.
        System.out.println("longMulti = " + result);
