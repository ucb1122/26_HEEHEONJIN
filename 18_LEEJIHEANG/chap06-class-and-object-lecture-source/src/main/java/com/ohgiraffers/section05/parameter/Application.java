...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        * 리터럴 값(참조 주소값 x)을 전달해서 메소드를 호출 시에는 서로 다른 지역변수는 서로 영향x*/
        int num = 20;
        ...
        * */
        int[] iArr = new int[] {1,2,3,4,5}; //iArr안에는 heap이 생성된 배열의 주소값을 가지고 있다.
        System.out.println("call byreference 전 : " + Arrays.toString(iArr));
        pt.testPrimitiveTypeArrayParameter(iArr);
        System.out.println("call byreference 후 : " +  Arrays.toString(iArr));
